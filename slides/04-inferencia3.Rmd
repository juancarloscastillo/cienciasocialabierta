...
- en estadística inferencial, el **nivel de confianza** equivale a:
  -  .content-box-red[1 - probabilidad de error]

- el nivel de probabilidad de error aceptadono es un criterio estadístico, es **convencional**
