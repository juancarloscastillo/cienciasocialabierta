...
- en nuestro repositorio Github:
  ...
  - seleccionar carpeta a publicar: en general raíz o docs
  - seleccionar tema 
  - guardar, genera un readme por defecto que será la front page
  - publicado en la dirección que se indica

---
![:scale 120%](gitpages.png)

---
# Github pages

- al repo se le agrega el archivo _config.yml, que es el generador del sitio (site generator) que indica el tema de Jekyll (se puede cambiar posteriormente)
...
---
## Y tenemos nuestro sitio publicado en la web
...
- lo mejor es hacerlo local, por las mayores posibilidades de edición -> git clone
